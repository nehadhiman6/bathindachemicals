<script setup>
   import {   ref,  computed, onMounted, onUnmounted,  reactive} from 'vue';
    ...
    const emit = defineEmits(['updateBank','update:modelValue']);
    ...
    const props = defineProps(
        ...
        url:{default:'banks/filtered',type: String},
        ...
        placeholder:{default:'Select Bank',type:String},
    ...
    const intialiseSelect = ()=>{
        ...
        var item = itemComponent.select2({
            ...
            data:props.initials,
            dropdownParent:$('body'),
            dropdownCssClass: "bank_drop_"+props.index,
            ajax: {
                method:'POST',
                url: function() {
        ...
        .on('change', function () {
            ...
            if(props.multiple == false){
               ...
               emit('updateBank',item,props.index);
            }
        })
        .on('select2:select', function (e) {
            ...
            if( selected_data.value != {}){
               emit('updateBank',item,props.index,selected_data.value);
            }
        })
        ...
        .on('select2:open', (e) => {
            if(props.multiple == false){
                document.querySelector('.bank_drop_'+props.index+' .select2-search__field').focus();
            }
        });
