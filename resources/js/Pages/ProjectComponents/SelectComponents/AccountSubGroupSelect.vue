<script setup>
   import {   ref,  computed, onMounted, onUnmounted,  reactive} from 'vue';
    ...
    const props = defineProps(
        ...
        url:{default:'account-sub-groups/filtered',type: String},
        ...
        party_applicable:{default:'',type:[String]},
            ...
            ajax: {
                ...
                data: function (params) {
                    var query = {
                        ...
                        party_applicable:props.party_applicable
                    }
